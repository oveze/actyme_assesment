...
function TaskList({ user, setUser }) {
  ...
  const fetchTasks = async () => {
    try {
      const response = await fetch('https://actyme-assesment-backf.onrender.com/api/tasks');
  ...
  const handleComplete = async (taskId) => {
    ...
    try {
      const response = await fetch('https://actyme-assesment-backf.onrender.com/api/tasks/complete', {
        method: 'POST',
        headers: {
  ...
  const handleDeleteTask = async () => {
    ...
    try {
      const response = await fetch(`https://actyme-assesment-backf.onrender.com/api/tasks/delete/${taskToDelete.id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'x-auth-token': localStorage.getItem('token'),
  ...
  const handleCreateTask = async () => {
    ...
    try {
      const response = await fetch('https://actyme-assesment-backf.onrender.com/api/tasks/createTask', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'x-auth-token': localStorage.getItem('token'),
